 ...
 *
 * @link       https://github.com/AgriLife/af4-aglifesciences/blob/master/templates/student-org-search.php
 * @since      0.6.0
...
// Page content.
add_action( 'wp_enqueue_scripts', 'student_organization_search_scripts', 12 );
add_action( 'genesis_before_content', 'student_organization_filters' );
add_action( 'genesis_entry_content', 'student_organization_content' );
 ...
 * @return void
 */
function student_organization_search_scripts() {
 ...
 * @return void
 */
function student_organization_filters() {
	...
	$output              = '';
	$query               = aso_get_posts( array( 'fields' => 'ids' ) );
